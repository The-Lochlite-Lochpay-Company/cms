...
class CommentsController extends \App\Http\Controllers\Controller implements HasMiddleware
{
    /**
    ...
    public static function middleware(): array
    {
        ...
        return [
            ...
            'auth',
            new Middleware(\Spatie\Permission\Middleware\PermissionMiddleware::using('publish system|edit system|delete system|publish comments|edit comments|delete comments,sanctum'), only:['index', 'show']),
            new Middleware(\Spatie\Permission\Middleware\PermissionMiddleware::using('publish system|publish comments'), only:['create', 'store']),
            new Middleware(\Spatie\Permission\Middleware\PermissionMiddleware::using('edit system|edit comments'), only:['edit','update','cleandata']),
            new Middleware(\Spatie\Permission\Middleware\PermissionMiddleware::using('delete system|delete comments'), only:['destroy']),
        ];
    }
