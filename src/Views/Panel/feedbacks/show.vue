...
<AppLayout :menuitems="menuitems" :avatar="avatar" :role="role" :name="name" :version="version" :breadcrumbCurrentTitle="breadcrumbCurrentTitle" :breadcrumbCurrentSection="breadcrumbCurrentSection" :title="title">
        <template #breadcrumb>
              <li class="breadcrumb-item active text-truncate w-50" aria-current="page">Feedback: {{ feedback.id }} - {{ feedback.question }}</li>
        </template>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="card-title h3 fw-bold my-3">Respostas Possíveis</div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="row">
                <div class="col">
                ...
                <div class="col">
                <div class="form-group">
                    <strong>Opção 4:</strong>
                    {{ feedback.option4 }}
                </div>
                </div>
                <div class="col">
                <div class="form-group">
                    <strong>Opção 5:</strong>
                    {{ feedback.option5 }}
                </div>
                </div>
                </div>
