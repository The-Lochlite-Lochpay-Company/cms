        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                     ...
                     <JetInput id="name" type="text" class="form-control mt-1 block w-full" placeholder="Nome" v-model="form.name" name="name" autocomplete="name" required />
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                     ...
                     <JetInput id="email" type="email" class="form-control mt-1 block w-full" placeholder="Email" v-model="form.email" name="email" autocomplete="email" required />
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                     ...
                     <JetInput id="password" type="password" class="form-control mt-1 block w-full" placeholder="Nova senha" v-model="form.password" name="password" autocomplete="new-password" required />
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                     ...
                     <JetInput id="password_confirmation" type="password" class="form-control mt-1 block w-full" placeholder="Confirme a nova senha" v-model="form.password_confirmation" name="password_confirmation" autocomplete="new-password" required />
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <div class="form-check" v-for="(row, index) in roles">
					  <JetCheckbox class="h-4 w-4 border border-gray-300 rounded-sm me-2 mr-2" type="checkbox" :id="'flexSelectOptionrow' + row.id" :value="row.id" v-model="form.roles" name="roles[]" />
