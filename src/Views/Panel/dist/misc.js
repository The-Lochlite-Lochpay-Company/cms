export var ChartColor = ["#5D62B4", "#54C3BE", "#EF726F", "#F9C446", "rgb(93.0, 98.0, 180.0)", "#21B7EC", "#04BCCC"];
export var primaryColor = getComputedStyle(document.body).getPropertyValue('--primary');
export var secondaryColor = getComputedStyle(document.body).getPropertyValue('--secondary');
export var successColor = getComputedStyle(document.body).getPropertyValue('--success');
export var warningColor = getComputedStyle(document.body).getPropertyValue('--warning');
export var dangerColor = getComputedStyle(document.body).getPropertyValue('--danger');
export var infoColor = getComputedStyle(document.body).getPropertyValue('--info');
export var darkColor = getComputedStyle(document.body).getPropertyValue('--dark');
export var lightColor = getComputedStyle(document.body).getPropertyValue('--light');
...
if ($('canvas').length) {
  ...
  Chart.defaults.color = '#354d66';
  Chart.defaults.font.family = '"Poppins", sans-serif';
  Chart.defaults.plugins.tooltip.custom = function (tooltipModel) {
    // Tooltip Element
  ...
  Chart.defaults.plugins.legend.labels.fontStyle = "italic";
