...
const form = useForm({
    domain: props.emailverify.domain,
    default: props.emailverify.default,
    logo: props.emailverify.logo,
    image: props.emailverify.image,
    imagevisible: props.emailverify.imagevisible,
    emphasis: props.emailverify.emphasis,
    instruction: props.emailverify.instruction,
    title: props.emailverify.title,
    description: props.emailverify.description,
    confirmationsend: props.emailverify.confirmationsend,
    changeemailtext: props.emailverify.changeemailtext,
    buttontext: props.emailverify.buttontext,
    buttoncolor: props.emailverify.buttoncolor,
    buttontextcolor: props.emailverify.buttontextcolor,
});
const submit = () => {
    form.put(route('manageremailverify.update', {id: props.emailverify.id}));
};
</script>
...
<AppLayout :menuitems="menuitems" :avatar="avatar" :role="role" :name="name" :version="version" :breadcrumbCurrentTitle="breadcrumbCurrentTitle" :breadcrumbCurrentSection="breadcrumbCurrentSection" :title="title">
        <template #breadcrumb>
              <li class="breadcrumb-item active" aria-current="page">Editar página de recuperação de senha</li>
        </template>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4">
                <div class="form-group">
                     ...
                     <input id="changeemailtext" class="form-control mt-1 block w-full" placeholder="changeemailtext" v-model="form.changeemailtext" name="changeemailtext" autocomplete required>
            ...
            <div class="col-xs-12 col-sm-12 col-md-4">
                <div class="form-group">
                     ...
                     <input id="confirmationsend" class="form-control mt-1 block w-full" placeholder="confirmationsend" v-model="form.confirmationsend" name="confirmationsend" autocomplete required>
