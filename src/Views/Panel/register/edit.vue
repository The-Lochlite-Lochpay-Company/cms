...
const form = useForm({
    ...
    default: props.register.default,
    logo: props.register.logo,
    image: props.register.image,
    imagevisible: props.register.imagevisible,
    emphasis: props.register.emphasis,
    title: props.register.title,
    description: props.register.description,
    logintext: props.register.logintext,
    buttontext: props.register.buttontext,
    buttoncolor: props.register.buttoncolor,
    buttontextcolor: props.register.buttontextcolor,
    google: props.register.google,
    facebook: props.register.facebook,
    twitter: props.register.twitter,
    goprovider: props.register.goprovider,
    fbprovider: props.register.fbprovider,
    ttprovider: props.register.ttprovider,
});
const submit = () => {
    form.put(route('managerregister.update', {id: props.register.id}));
};
</script>
...
<AppLayout :menuitems="menuitems" :avatar="avatar" :role="role" :name="name" :version="version" :breadcrumbCurrentTitle="breadcrumbCurrentTitle" :breadcrumbCurrentSection="breadcrumbCurrentSection" :title="title">
        <template #breadcrumb>
              <li class="breadcrumb-item active" aria-current="page">Nova página de register</li>
        </template>
