...
<AppLayout :menulang="menulang" :menuitems="menuitems" :avatar="avatar" :role="role" :name="name" :version="version" :breadcrumbCurrentTitle="breadcrumbCurrentTitle" :breadcrumbCurrentSection="breadcrumbCurrentSection" :title="title">
        <template #breadcrumb>
              <li class="breadcrumb-item active text-truncate w-50" aria-current="page">Reply: {{ feedback.id }} - {{ feedback.name }}</li>
        </template>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                    <strong>Updated in:</strong>
                    {{ new Date(feedback.updated_at).toLocaleString() }}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="card-title h3 fw-bold my-3">Questions and answers</div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
