...
const form = useForm({
         domain: props.mainmenu.domain,
         menuclass: props.mainmenu.menuclass,
         menuid: props.mainmenu.menuid,
         name: props.mainmenu.name,
         brand: props.mainmenu.brand,
         brandtype: props.mainmenu.brandtype,
         button1: props.mainmenu.button1,
         button1id: props.mainmenu.button1id,
         button1class: props.mainmenu.button1class,
         button1route: props.mainmenu.button1route,
         button1status: props.mainmenu.button1status,
         button2: props.mainmenu.button2,
         button2id: props.mainmenu.button2id,
         button2class: props.mainmenu.button2class,
         button2route: props.mainmenu.button2route,
         button2status: props.mainmenu.button2status,
         facebook: props.mainmenu.facebook,
         twitter: props.mainmenu.twitter,
         linkedin: props.mainmenu.linkedin,
         pinterest: props.mainmenu.pinterest,
         instagram: props.mainmenu.instagram,
         tiktok: props.mainmenu.tiktok,
         whatsapp: props.mainmenu.whatsapp,
         youtube: props.mainmenu.youtube,
         search: props.mainmenu.search,
         searchroute: props.mainmenu.searchroute,
         stickytop: props.mainmenu.stickytop,
         itemscenter: props.mainmenu.itemscenter,
         type: props.mainmenu.type,
         default: props.mainmenu.default,
         status: props.mainmenu.status,
});
const submit = (event) => {
    form.put(route('managermainmenu.update', {id: event.submitter.dataset.menu}));
};
</script>
...
<AppLayout :menulang="menulang" :menuitems="menuitems" :avatar="avatar" :role="role" :name="name" :version="version" :breadcrumbCurrentTitle="breadcrumbCurrentTitle" :breadcrumbCurrentSection="breadcrumbCurrentSection" :title="title">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                <JetButton type="submit" class="btn btn-primary" title="Atualizar" aria-label="Atualizar" :class="{ 'opacity-25': form.processing }" :disabled="form.processing" data-event="submit" data-function="delete" :data-menu="mainmenu.id">Atualizar</JetButton>
            </div>
        </div>
      </form>
