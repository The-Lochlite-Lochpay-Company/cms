...
<AppLayout :menulang="menulang" :menuitems="menuitems" :avatar="avatar" :role="role" :name="name" :version="version" :breadcrumbCurrentTitle="breadcrumbCurrentTitle" :breadcrumbCurrentSection="breadcrumbCurrentSection" :title="title">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4">
                <div class="form-group">
                     <JetLabel for="imagecap" value="Cover image" />
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                     <JetLabel for="description" value="Article summary" />
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 mb-3 rowcolumneditor">
             <MylochiTinyEditor data-type="edit" placeholder="Write the content of the article here" v-model="form.body" name="body" id="mylochi-tiny" :data-body="postbody.body"></MylochiTinyEditor>
	        </div>
            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                <JetButton type="submit" class="btn btn-primary" title="Publish" aria-label="Publish" :data-post="post.id" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">Publish</JetButton>
            </div>
        </div>
      </form>
