...
const submit = () => {
	...
	objall['api'] = objapi;
	form.items = objall;
    form.post(route('managerservices.store'));
};
...
<template>
<AppLayout :menulang="menulang" :menuitems="menulang" :apiitems="apiitems" :avatar="avatar" :role="role" :name="name" :version="version" :breadcrumbCurrentTitle="breadcrumbCurrentTitle" :breadcrumbCurrentSection="breadcrumbCurrentSection" :title="title">
        <template #breadcrumb>
        ...
        <div class="row">
            ...
            <div id="item1" class="border border-primary py-2 px-2 apiitem mb-4">
            <div class="row">
			
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                     <JetLabel for="key" value="Key" />
                     <JetInput id="key1" type="text" class="form-control mt-1 block w-full" placeholder="Key" name="key" autocomplete="key" required />
                     <JetInputError for="key1" class="mt-2" />
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                     <JetLabel for="value1" value="Value" />
                     <JetInput id="value1" type="text" class="form-control mt-1 block w-full" placeholder="Value" name="value" autocomplete="value" required />
                     <JetInputError for="value1" class="mt-2" />
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                <JetButton type="submit" class="btn btn-primary" title="To save" aria-label="To save" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">To save</JetButton>
            </div>
        </div>
      </form>
