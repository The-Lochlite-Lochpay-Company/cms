        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                     ...
                     <JetInput id="password" type="password" class="form-control mt-1 block w-full" placeholder="New Password" v-model="form.password" name="password" autocomplete="new-password" />
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                     ...
                     <JetInput id="password_confirmation" type="password" class="form-control mt-1 block w-full" placeholder="Confirm the new password" v-model="form.password_confirmation" name="password_confirmation" autocomplete="new-password" />
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                <JetButton type="submit" class="btn btn-primary" title="Update" aria-label="Update" :data-user="userid" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">Update</JetButton>
            </div>
        </div>
      </form>
