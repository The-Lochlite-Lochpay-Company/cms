        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
					 ...
					 <option value="received" :selected="contact.status == 'received'">Received</option>
					 <option value="answered" :selected="contact.status == 'answered'">Answered</option>
					 <option value="refused"  :selected="contact.status == 'refused'">Refused</option>
					 </select>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                <JetButton type="submit" class="btn btn-primary" title="Update" aria-label="Update" :data-contact="contact.id" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">Update</JetButton>
            </div>
      </form>
