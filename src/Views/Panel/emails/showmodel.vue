...
<AppLayout :menuitems="menuitems" :avatar="avatar" :role="role" :name="name" :version="version" :breadcrumbCurrentTitle="breadcrumbCurrentTitle" :breadcrumbCurrentSection="breadcrumbCurrentSection" :title="title">
        <template #breadcrumb>
              <li class="breadcrumb-item active" aria-current="page">Modelo: {{ model.id }} - {{ model.subject }}</li>
        </template>
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <div class="card card-body bg-light mt-3"><div class="card-text text-start">{{ model.html_template }}</div></div>
                </div>
            </div>
        </div>
</AppLayout>
