...
import sidebar from '@/Pages/modules/sidebar.vue';
...
<template>
            ...
            <section>
                <div class="flex space-x-6 text-gray-400 font-medium">
                    <div class="hover:text-gray-700 dark:hover:text-white">Painel do aluno</div>
                </div>
            </section>

            <section class="mt-9">
                <div class="flex items-center justify-between">
                    <span class="font-semibold text-gray-700 text-base text-dark">Meus cursos</span>
                ...
                <div class="mt-4 grid grid-cols-2 gap-y-5 sm:grid-cols-4 gap-x-5 ">
                    <div v-for="row in courses.data" class="flex flex-col rounded-xl overflow-hidden aspect-square border dark:border-zinc-600">
            ...
            <section class="mt-9">
                <div class="flex items-center justify-between">
                    <span class="font-semibold text-gray-700 text-base dark:text-white">Cursos disponiveis</span>
                    <div class="flex items-center space-x-2 fill-gray-500">
                        <svg class="h-7 w-7 rounded-full border p-1 hover:border-red-600 hover:fill-red-600 dark:fill-white dark:hover:fill-red-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path d="M13.293 6.293L7.58 12l5.7 5.7 1.41-1.42 -4.3-4.3 4.29-4.293Z"></path>
                        </svg>
